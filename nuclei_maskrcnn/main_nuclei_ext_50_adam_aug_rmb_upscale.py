...
epoch_number_all_fast = 10
epoch_number_all_slow = 10
epoch_number_iter = 0
    ...
    if train_all:
        ...
        while epoch_add < epoch_number_iter:
            ...
            if epoch_add >= 2 and val_mAP[-1] < val_mAP[-2] and val_mAP[-1] < val_mAP[-3]:
                break
            epoch_add += 1
            model.train(dataset_train, dataset_val, learning_rate=config_all.LEARNING_RATE/10., epochs=epoch_init_slow+epoch_add, layers='all')
        del model
