...
import utils
import model_resnet50_aug_rmb_inddemean as modellib
...
if train_flag:
    ...
    if train_all:
        ...
        epoch_add = 0
        model.train(dataset_train, dataset_val, learning_rate=config_all.LEARNING_RATE, epochs=epoch_init, layers="heads")
        # model.train(dataset_train, dataset_val, learning_rate=config_all.LEARNING_RATE, epochs=epoch_init, layers="4+")
        model.train(dataset_train, dataset_val, learning_rate=config_all.LEARNING_RATE/10., epochs=epoch_init+epoch_number_init_all, layers="all")
        del model
